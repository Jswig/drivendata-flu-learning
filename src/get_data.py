...
train_labels_url = (
    "https://s3.amazonaws.com/drivendata-prod/data/66/public/training_set_labels.csv"
)

test_features_url = (
    "https://s3.amazonaws.com/drivendata-prod/data/66/public/test_set_features.csv"
)

sample_sub_url = (
    "https://s3.amazonaws.com/drivendata-prod/data/66/public/submission_format.csv"
)
